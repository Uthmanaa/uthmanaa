...
<main role="main" class="container">
  <div class="starter-template animate2 two">
    ...
    <div class="container slideanim mb-5">
      ...
      <h2>Get In Touch</h2>
      <p class="">If possible you find any bug on this website, please na <strong><i>God</i></strong> I used take beg you, send me a message on my Gmail <a href="mailto:animashaunua@gmail.com" class="text-info footer-mail-link">here</a></p>
    </div>
  </div>
